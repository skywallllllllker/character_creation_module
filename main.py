...
def attack(char_name: str, char_class: str) -> str:
    """Выполняет атаку персонажа на основе его класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выполняет защиту персонажа на основе его класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выполняет специальное действие персонажа на основе его класса."""
    if char_class == 'warrior':
